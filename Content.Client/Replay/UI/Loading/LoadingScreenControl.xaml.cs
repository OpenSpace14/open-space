...
public sealed partial class LoadingScreenControl : Control
{
    ...
    public LoadingScreenControl(IResourceCache resCache)
    {
        ...
        Header.FontOverride = resCache.NotoStack2ElectricBoogaloo("/Fonts/Widock/Widock.otf", 24);
        Subtext.FontOverride = resCache.NotoStack2ElectricBoogaloo("/Fonts/Widock/Widock.otf", 12);
